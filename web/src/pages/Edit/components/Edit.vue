<template>
  ...
  >
    ...
    <AiSummaryDialog v-if="mindMap && enableAi" :mindMap="mindMap"></AiSummaryDialog>
    <div
      class="dragMask"
      v-if="showDragMask"
  ...
  methods: {
    ...
    autoSaveToServer() {
      ...
      this.autoSaveTimer = setTimeout(async () => {
        try {
          const content = this.mindMap.getData(true)
    ...
    manualSave(isManualSave = true) {
      storeData(this.mindMap.getData(true), isManualSave)
    },
